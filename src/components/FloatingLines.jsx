...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    let active = true;
    let isVisible = true; // Optimization: Toggle render frame calls
    ...
    // ⚡ OPTIMIZATION 1: Cap at 1 instead of high DPR ratios to prevent performance choke
    ...
    // ⚡ OPTIMIZATION 2: Intersection Observer to pause rendering when component scrolls out of view
    ...
    if (interactive) {
      // ⚡ OPTIMIZATION 3: Using passive events so scrolling doesn't wait for Javascript execution threads
