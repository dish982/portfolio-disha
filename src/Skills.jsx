...
const skillsData = [
  {
    ...
    skills: [
      ...
      { name: "Node.js", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nodejs/nodejs-original.svg", proficiency: 60 },
      { name: "Express", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg", proficiency: 60 },
  ...
  },
  {
    ...
    icon: "chart",
    skills: [
      { name: "Python", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/python/python-original.svg", proficiency: 75 },
      { name: "Pandas", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/pandas/pandas-original.svg", proficiency: 80 },
      { name: "NumPy", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/numpy/numpy-original.svg", proficiency: 75 },
      { name: "EDA", img: "https://img.icons8.com/color/48/analytics.png", proficiency: 80 },
    ]
  },
  {
    category: "Database",
    ...
    icon: "db",
    skills: [
      { name: "MongoDB", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mongodb/mongodb-original.svg", proficiency: 75 },
      { name: "MySQL", img: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" , proficiency: 65 },
    ]
  },
  {
    category: "Tools",
    ...
    skills: [
      ...
      { name: "Postman", img: "https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg", proficiency: 70 },
        ...
        <div className="grid grid-cols-1 gap-4 pt-2 md:grid-cols-2 md:gap-6">
          ...
          <div className="bg-white/50 border border-[#8B2D38]/10 rounded-xl p-8 shadow-sm">
            ...
            {skillsData[1].skills.map((skill, index) => (
              <div key={index} className="flex flex-col items-center gap-2">
                <div className=" relative group w-full aspect-square bg-white border border-[#8B2D38]/5 rounded-2xl p-3 flex items-center justify-center shadow-sm">
                  <img 
                    src={skill.img} 
                    alt={skill.name} 
                    className="w-10 h-10 object-contain" 
